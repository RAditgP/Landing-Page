...
export default function TemplatePage() {
  const templates = [
    {
      ...
      tag: "Populer",
      category: "Personal",
      useUrl: "/checkout?template=portfolio-pro",
  ...
  const testimonials = [
    {
      quote:
        "Template DevLaunch sangat menghemat waktu! Desainnya modern dan mudah di kustomisasi.",
      author: "Susi W., Freelancer",
    },
    {
      quote:
        "Sangat responsif dan cepat. Website startup kami berhasil naik dalam 30 menit.",
      author: "Bima H., CTO Startup",
    },
    {
      quote:
        "Pilihan kategorinya banyak dan terstruktur. Akhirnya ketemu template dashboard yang pas.",
      author: "Ayu P., Project Manager",
    },
  ];
      ...
      <section className="text-white flex flex-col items-center px-6 py-20">
        ...
        <div className="flex flex-wrap justify-center gap-3 max-w-7xl w-full mb-16">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setSelectedCategory(cat)} // 👈 aktifkan filter
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="bg-gray-900 p-6 rounded-xl border border-gray-700 shadow-xl"
              >
                <p className="text-xl italic text-gray-300 mb-4">"{t.quote}"</p>
