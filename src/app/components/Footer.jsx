      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 border-b border-gray-700 pb-10 mb-8">
          ...
          <div className="col-span-2 md:col-span-2">
            <h3 className="text-2xl font-extrabold mb-3 text-white">DevLaunch</h3>
            ...
            <div className="flex gap-4 mt-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/gp_raditya/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
              ...
              {/* GitHub */}
              <a href="https://github.com/RAditgP" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="text-center text-sm pt-4">
          <p className="text-gray-500">
            © {currentYear} DevLaunch. Semua hak dilindungi. | Dibuat dengan ✨ oleh Devlaunch
          </p>
        </div>
      </div>
    </footer>
